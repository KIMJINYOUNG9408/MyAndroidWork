...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dlg1.setOwnerActivity(MainActivity.this); // 메인엑티비트의 다이얼로그
        dlg1.setCanceledOnTouchOutside(true); // 다이얼로그 바깥 영역 클릭시 (혹은 back 버튼 클릭시 ) hide상태가 된다.
                                            //종료 할것인지 여부, true : 종료 , false : 종료X
