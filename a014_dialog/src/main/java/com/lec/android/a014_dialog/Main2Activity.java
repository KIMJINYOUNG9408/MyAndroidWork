        ...
        switch (id){
            ...
            case DIALOG_RADIO:
                ...
                builder3.setTitle("색을 고르세요")
                        ...
                        .setNegativeButton("취소",null)
                        .setSingleChoiceItems(str2, -1, new DialogInterface.OnClickListener() { // 리스트 배열목록 , 기본값설정 ,
            ...
            case DIALOG_MULTICHOICE:
                ...
                final String [] data = {"벨기에", "잉글랜드", "독일", "프랑스", "이탈리아", "스폐인"};
                final boolean [] checked = {false, false, true, false, false, false};
