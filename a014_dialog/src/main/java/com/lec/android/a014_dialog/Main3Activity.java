        ...
        switch (id){
            case DIALOG_DATE:
                DatePickerDialog dpd = new DatePickerDialog(
                        this, // 현재 화면의 제어권자.
                        new DatePickerDialog.OnDateSetListener() { // 날짜 설정 후 Dialog 빠져나올때 호출되는 콜백.
                            @Override
                ...
                TimePickerDialog tpd = new TimePickerDialog(
                        ...
                        new TimePickerDialog.OnTimeSetListener() { // 시간 값 선택후 호출되는 콜백
                            ...
                            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                Toast.makeText(getApplicationContext(),hourOfDay + "시 " + minute + "분 " , Toast.LENGTH_LONG ).show();
                            }
                        },17,21,false // 기본 값 시 분 true : 24시간제 false: 오전 / 오후 항목표사
                );
                tpd.show();
                return tpd;
        }
