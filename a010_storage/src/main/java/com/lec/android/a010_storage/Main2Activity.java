...
// deviece file explorer - > sdcard -> pictures에 만들어짐.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    //Environment.getExternalStoragePublicDirectory(); API 29 부터 deprecated
                    // 저장 경로 가져오기
                    File path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES);
                    File f = new File(path,"external.txt"); // 경로 / 파일명.
                    FileWriter writer = new FileWriter(f,false); // trye 이면 append 모드 // false 이면 write 모드
