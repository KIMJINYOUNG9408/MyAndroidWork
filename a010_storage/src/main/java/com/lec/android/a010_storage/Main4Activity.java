...
public class Main4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.e("myapp","데이터베이스를 열 수 없슴"); // logcat의 error에 표시
        }
    ...
    void update(String name, int age, String address){
        ...
        // 리턴값은 affected rows
        int cnt = db.update(tableName,values,"name=?",new String[]{name}); // 테이블명 , 변경할 값들 , where 조건절 , 조건절의 ? 값들
    ...
    void delete(String name){
        ...
        // 리턴 값은 affected rows
        int cnt = db.delete(tableName,"name=?",new String[]{name}); // 테이블명 , WHERE 절 , 그 값.
