...
public class Main2Activity extends AppCompatActivity {
        ...
        btnLocate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(btnLocate.isChecked()){ // 토글 버튼
                    ...
                    // 주어진 위치 제공자가 기억하는 가장 최근의 위치정보 획득, 없으면 null 리턴
    ...
    // LocationManager 로 부터 전달되는 위치 정보를 받기위해 정의
    class MyListener implements LocationListener {
        ...
        protected  String locationInfo(Location location){
            ...
            return "위치정보 : " + provider + " 경도 : " + longitude + " 위도 : " + latitude +
        ...
        switch (requestCode){
            case REQUEST_CODE :
                if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast.makeText(this, "권환획득 실패", Toast.LENGTH_LONG).show();
                }
        }
