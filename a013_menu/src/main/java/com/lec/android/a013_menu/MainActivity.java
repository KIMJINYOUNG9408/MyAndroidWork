...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        Log.d("myapp","onCreateOptionsMenu - 최초 메뉴키를 눌렀을때 호출");
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        Log.d("myapp","onPrepareOptionsMenu - 옵션메뉴가 화면에 보여질때 마다 호출");

        // 메뉴가 보여질때마다 '로그인','로그아웃'이 enable/disable 토글되게 보이기
        if(blog){ //  로그인 상태
            // getItem(index) index번째 리턴.
